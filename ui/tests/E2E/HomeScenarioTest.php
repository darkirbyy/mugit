...
final class HomeScenarioTest extends E2EControllerTest
{
    ...
    public function homeChangeThemeToDark(): void
    {
        ...
        $this->assertAnySelectorTextContains('div', 'layout.navbar.mySSHKeys');
        $this->assertAnySelectorTextContains('div', 'layout.navbar.appearance');
        $this->assertAnySelectorTextContains('div', 'layout.navbar.myAccount');
        $this->assertAnySelectorTextContains('div', 'layout.navbar.backToHub');
        $this->assertAnySelectorTextContains('div', 'layout.navbar.signOut');

        // Click the appearance button
        $this->clickElement('button-navbar-appearance');

        // Check appearance sub-menu content
        $this->assertAnySelectorTextContains('div', 'layout.navbar.theme.light');
        $this->assertAnySelectorTextContains('div', 'layout.navbar.theme.dark');
        $this->assertAnySelectorTextContains('div', 'layout.navbar.theme.auto');
